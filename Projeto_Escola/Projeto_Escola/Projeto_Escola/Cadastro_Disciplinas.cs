...
namespace Projeto_Escola
{
    ...
    {
        static string strCn = @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\\Users\\User\\Downloads\\Projeto_Escola-jose-renan-20180426T141559Z-001\\Projeto_Escola-jose-renan\\Projeto_Escola\\bin\\Debug\\Bd_Escola.accdb";
...
string remove = "delete from disciplinas where Id= " + txbCadSigla.Text; 
...
conexao.Close(); 
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            string altera = "update disciplinas set Nome= '" + txbCadSigla.Text +
            "', descrição= '" + txbCadDesc.Text +
            "', sigla= '" + txbCadSigla.Text +
            "' where sigla= " + txbCadSigla.Text;
